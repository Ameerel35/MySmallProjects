...
tenant = tenantBuilder.Tenant("Games")
# redactor = Redactor()
...
prompt = f"""You are a {tenant.role} reviewer. Inspect the {profile} file and provide a summary 
            on the game. State your role as well and cite APIs used."""
